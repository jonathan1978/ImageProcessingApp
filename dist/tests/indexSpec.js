...
describe('Test for endpoint requests and responses', function () {
    ...
    describe('Image transform function should resolve or reject', function () {
        ...
        it('show error if file does not exist', function () { return __awaiter(void 0, void 0, void 0, function () {
            var data;
            return __generator(this, function (_a) {
                switch (_a.label) {
